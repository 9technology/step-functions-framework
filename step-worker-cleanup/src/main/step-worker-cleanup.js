...
exports.handler = function(event, context) {
    ...
    var proc = child_process.spawn('./stepworkercleanup', [ project, env, region, mode, configbucket, configbucketkey, executionarn, result ], [ JSON.stringify(event) ], { stdio: 'inherit' });
